...
const form = useForm({
    ...
    duration_months: props.formation.duration_months,
...
const submit = () => {
    form.put(`/campus/formations/${props.formation.id}`)
}
</script>
...
<template>
    ...
    <div class="max-w-[720px] mx-auto space-y-xl">
        ...
        <div class="flex items-center gap-md">
            <Link :href="`/campus/formations/${formation.id}`" class="icon-back">
        ...
        <form @submit.prevent="submit" class="card space-y-lg">
            ...
            <div class="form-actions">
                <Link :href="`/campus/formations/${formation.id}`" class="btn-secondary">Annuler</Link>
